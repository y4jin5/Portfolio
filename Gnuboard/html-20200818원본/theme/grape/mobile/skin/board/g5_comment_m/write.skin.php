...
<section id="bo_w">
    ...
    <div class="bo_w_tit">
        ...
        <div id="autosave_wrapper" style="display:none">
            <input type="text" name="wr_subject" value="<?php echo $member['mb_nick']; ?>님의 한줄 칭찬글 입니다." id="wr_subject" required class="frm_input full_input required" size="50" maxlength="255" placeholder="제목">
    ...
    <label for="wr_content" class="sound_only">내용<strong>필수</strong></label>
        <div class="wr_content ">
			...
			<textarea id="wr_content" name="wr_content" class="" maxlength="65536" placeholder="내용을 입력해주세요." style="width:1107px;height:70px"></textarea>
			<span class="sound_only">웹 에디터 끝</span>
			<!-- 최소/최대 글자 수 사용 시 -->
			<input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn_submit btn" style="height:70px">
            <div id="char_count_wrap" style="display:none"><span id="char_count">0</span>글자</div>
         </div>

...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_name sv_use"><?php echo $list[$i]['wr_name'] ?> <span class="view_con"><a href="<?php echo $list[$i]['href'] ?>">[ 내용보기 ]</a></span></td>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl">
        <option value="wr_name"<?php echo get_selected($sfl, 'wr_name', true); ?>>예약자명</option>
    </select>

...
<div class="idx_con">
    <ul>
        <li>
            <h2><i class="fa fa-envelope-open-o "></i><span style="color:rgb(80, 80, 80);">새소식</span></h2>
        ...
        <li>
            <h2><i class="fa fa-user-md"></i><span style="color:rgb(80, 80, 80);">의료진 소개</span></h2>
            <a href="" style="color:#ccc">자세히보기</a>
        </li> 

        <li>
            <h2><i class="fa fa-hospital-o"></i><span style="color:rgb(80, 80, 80);">지점 안내</span></h2>
            <!-- <p>진료일정을 확인하세요. </p> -->
            <a href="" style="color:#ccc">자세히보기</a>
        </li>
        <li>
            <h2><i class="fa fa-search"></i><span style="color:rgb(80, 80, 80);">자주하는 질문</span></h2>

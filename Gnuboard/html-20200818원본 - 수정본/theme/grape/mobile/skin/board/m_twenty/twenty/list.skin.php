...
<link href="<?php echo $board_skin_url?>/css/twentytwenty.css" rel="stylesheet" type="text/css" />
            ...
            <ul class="gall_con">
                <li class="gall_href twentytwenty-container">
                    ...
                    <?php
                        ...
                        $thumb2 = get_list_thumbnail2($board['bo_table'], $list[$i]['wr_id'], $board['bo_mobile_gallery_width'], $board['bo_mobile_gallery_height']);
                        ...
                        if($thumb2['src']) {
                            ...
                            $img_content2 = '<span style="width:'.$board['bo_mobile_gallery_width'].'px;height:'.$board['bo_mobile_gallery_height'].'px">no image</span>';
                        }
...
<script src="<?php echo $board_skin_url?>/js/jquery.event.move.js"></script>
<script src="<?php echo $board_skin_url?>/js/jquery.twentytwenty.js"></script>
<script>

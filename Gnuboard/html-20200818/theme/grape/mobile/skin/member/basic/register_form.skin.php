...
<div class="register">
	...
	<div class="register_inner">
	    ...
	    <div class="form_01 personal_setting">
	        ...
	        <ul>
		        ...
		        <li class="frm_bar">
                    <span class="bo_chk li_chk">
                        <label for="reg_mb_sms" class="frm_label frm_sms"><span class="chk_img"></span> 휴대폰 문자메세지를 받겠습니다.</label>
		        ...
		        <li>
		        	<div class="frm_bar">
                        <span class="bo_chk li_chk">
                            <label for="reg_mb_open" class="frm_label info_open"><span class="chk_img"></span> 다른분들이 나의 정보를 볼 수 있도록 합니다.</label>
    ...
    <div class="btn_confirm">
	    <a href="<?php echo G5_URL ?>" class="btn_l btn_cancel">취소</a>
	    <button type="submit" value="<?php echo $w==''?'회원가입':'정보수정'; ?>" id="btn_submit" class="btn_l btn_submit" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
	</div>

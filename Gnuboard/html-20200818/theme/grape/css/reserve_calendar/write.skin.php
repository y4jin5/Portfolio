...
$(document).ready(function() {
    ...
    $.ajax({
        type: "POST",
         url: g5_bbs_url+'/time_ck.php',

        data: {
			
           "wr_1": document.fwrite.wr_1.value ,
            "wr_2": currtime,
            "bo_table":  document.fwrite.bo_table.value 
...
<!-- } 게시물 작성/수정 끝 	20180516	오전 10:30 SELECT * FROM `g5_write_fr` WHERE `wr_1`='20180516'and `wr_2`='오전 10:30'-->
